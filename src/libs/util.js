...
util.setCurrentPath = function(vm, name) {
  ...
  vm.$store.state.app.routers.forEach(element => {
    element.children.forEach(childItem => {
      if (element.name !== "home" && childItem.name == currentName) {
        currentPathArr = [
          { path: element.path, name: element.name, title: element.title },
          { path: childItem.path, name: childItem.name, title: childItem.title }
        ];
